...
// copy of final class TreeCellEditorPainter extends AbstractRegionPainter
public class MyTreeCellEditorPainter extends AbstractRegionPainter implements NimbusColors {

	private static final Logger LOG = Logger.getLogger(MyTreeCellEditorPainter.class.getName());
	
/*
in NimbusDefaults:        //Initialize \"Tree.cellEditor\"
        ...
        , TreeCellEditorPainter.BACKGROUND_ENABLED
 ...
 */
    ...
    public static Painter<JComponent> factory(int state) {
    	PaintContext ctx = new PaintContext
    			...
    			, false
    			, MyPaintContext.PaintContext.NINE_SQUARE_SCALE 
    			, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
    	return new MyTreeCellEditorPainter(ctx, state);
    }

// copy of final class javax.swing.plaf.nimbus.TreeCellEditorPainter extends AbstractRegionPainter starts here :
    ...
    public MyTreeCellEditorPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
