...
// copy of final class FileChooserPainter extends AbstractRegionPainter
public class MyFileChooserPainter extends AbstractRegionPainter implements NimbusColors {

	private static final Logger LOG = Logger.getLogger(MyFileChooserPainter.class.getName());
 ...
 */
	public static Dimension canvasSize() {
		return new Dimension(32, 32); // ab NEWFOLDERICON_ENABLED sind die Icons kleiner definiert
	}
    public static Painter<JComponent> factory(int state) {
    	PaintContext ctx = new PaintContext
    			( new Insets(5, 5, 5, 5), state>UPFOLDERICON_ENABLED ? canvasSize() : new Dimension(16, 16)
    			, false
    			, MyPaintContext.PaintContext.FIXED_SIZES 
    			, 1.0, 1.0);
    	return new MyFileChooserPainter(ctx, state);
    }

// copy of final class javax.swing.plaf.nimbus.FileChooserPainter extends AbstractRegionPainter starts here :
    ...
    public static final int FILEICON_ENABLED = 2;
    public static final int DIRECTORYICON_ENABLED = 3;
    public static final int UPFOLDERICON_ENABLED = 4;
    public static final int NEWFOLDERICON_ENABLED = 5;
    static final int COMPUTERICON_ENABLED = 6; // not implemented
    public static final int HARDDRIVEICON_ENABLED = 7;
    public static final int FLOPPYDRIVEICON_ENABLED = 8;
    public static final int HOMEFOLDERICON_ENABLED = 9;
    public static final int DETAILSVIEWICON_ENABLED = 10;
    public static final int LISTVIEWICON_ENABLED = 11;
    ...
    private Color color2 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", 0.007936537f, -0.065654516f, -0.13333333f, 0);
    private Color color3 = new Color(97, 98, 102, 255); // color for fileIcon bottom line
    private Color color4 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", -0.032679737f, -0.043332636f, 0.24705881f, 0);
    private Color color5 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", 0.0f, -0.110526316f, 0.25490195f, 0);
    private Color color6 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0077680945f, -0.51781034f, 0.3490196f, 0);
    private Color color7 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.013940871f, -0.599277f, 0.41960782f, 0);
    private Color color8 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.4198052f, 0.14117646f, 0);
    private Color color9 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0f, -0.6357143f, 0.45098037f, -127);
    private Color color10 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", 0.0f, 0.0f, -0.21f, -99);
    private Color color11 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 2.9569864E-4f, -0.45978838f, 0.2980392f, 0);
    private Color color12 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0015952587f, -0.34848025f, 0.18823528f, 0);
    private Color color13 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0015952587f, -0.30844158f, 0.09803921f, 0);
    private Color color14 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0015952587f, -0.27329817f, 0.035294116f, 0);
    private Color color15 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.6198413f, 0.43921566f, 0);
    private Color color16 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0f, -0.6357143f, 0.45098037f, -125);
    private Color color17 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0f, -0.6357143f, 0.45098037f, -50);
    private Color color18 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0f, -0.6357143f, 0.45098037f, -100);
    private Color color19 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0012094378f, -0.23571429f, -0.0784314f, 0);
    private Color color20 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 2.9569864E-4f, -0.115166366f, -0.2627451f, 0);
    private Color color21 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0027436614f, -0.335015f, 0.011764705f, 0);
    private Color color22 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0024294257f, -0.3857143f, 0.031372547f, 0);
    private Color color23 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0018081069f, -0.3595238f, -0.13725492f, 0);
    private Color color24 = new Color(255, 200, 0, 255);
    private Color color25 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.44904763f, 0.039215684f, 0);
    private Color color26 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0015952587f, -0.43718487f, -0.015686274f, 0);
    private Color color27 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 2.9569864E-4f, -0.39212453f, -0.24313727f, 0);
    private Color color28 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.6117143f, 0.43137252f, 0);
    private Color color29 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0012094378f, -0.28015873f, -0.019607842f, 0);
    private Color color30 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.00254488f, -0.07049692f, -0.2784314f, 0);
    private Color color31 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0015952587f, -0.28045115f, 0.04705882f, 0);
    private Color color32 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", 0.0f, 5.847961E-4f, -0.21568626f, 0);
    private Color color33 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0061469674f, 0.3642857f, 0.14509803f, 0);
    private Color color34 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0053939223f, 0.3642857f, -0.0901961f, 0);
    private Color color35 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0f, -0.6357143f, 0.45098037f, 0);
    private Color color36 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.006044388f, -0.23963585f, 0.45098037f, 0);
    private Color color37 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0063245893f, 0.01592505f, 0.4078431f, 0);
    private Color color38 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", 0.0f, -0.110526316f, 0.25490195f, -170);
    private Color color39 = MyPaintContext.decodeColor(NIMBUS_ORANGE, "nimbusOrange", -0.032758567f, -0.018273294f, 0.25098038f, 0);
    ...
    private Color color87 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.48756614f, 0.19215685f, 0);
    private Color color88 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.48399013f, 0.019607842f, 0);
    private Color color89 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0028941035f, -0.5906323f, 0.4078431f, 0);
    private Color color90 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.51290727f, 0.34509802f, 0);
    private Color color91 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.009583652f, -0.5642857f, 0.3843137f, 0);
    private Color color92 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0072231293f, -0.6074885f, 0.4235294f, 0);
    private Color color93 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 7.13408E-4f, -0.52158386f, 0.17254901f, 0);
    private Color color94 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.012257397f, -0.5775132f, 0.19215685f, 0);
    private Color color95 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.08801502f, -0.6164835f, -0.14117649f, 0);
    private Color color96 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.57865167f, -0.6357143f, -0.5019608f, 0);
    private Color color97 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0036516786f, -0.555393f, 0.42745095f, 0);
    private Color color98 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0010654926f, -0.3634138f, 0.2862745f, 0);
    private Color color99 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.57865167f, -0.6357143f, -0.29803923f, 0);
    private Color color100 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.57865167f, -0.6357143f, 0.12156862f, 0);
    private Color color101 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.57865167f, -0.6357143f, -0.54901963f, 0);
    private Color color102 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.57865167f, -0.6357143f, -0.48627454f, 0);
    private Color color103 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.57865167f, -0.6357143f, -0.007843137f, 0);
    private Color color104 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0028941035f, -0.5408867f, -0.09411767f, 0);
    private Color color105 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.011985004f, -0.54721874f, -0.10588238f, 0);
    private Color color106 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0022627711f, -0.4305861f, -0.0901961f, 0);
    private Color color107 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.00573498f, -0.447479f, -0.21568629f, 0);
    private Color color108 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.53271f, 0.36470586f, 0);
    private Color color109 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.5276062f, -0.11372551f, 0);
    private Color color110 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -8.738637E-4f, -0.5278006f, -0.0039215684f, 0);
    private Color color111 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0028941035f, -0.5338625f, -0.12549022f, 0);
    private Color color112 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", -0.03535354f, -0.008674465f, -0.32156864f, 0);
    private Color color113 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", -0.027777791f, -0.010526314f, -0.3529412f, 0);
    private Color color114 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0028941035f, -0.5234694f, -0.1647059f, 0);
    private Color color115 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.53401935f, -0.086274534f, 0);
    private Color color116 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.52077174f, -0.20784315f, 0);
    private Color color117 = new Color(108, 114, 120, 255);
    private Color color118 = new Color(77, 82, 87, 255);
    private Color color119 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.004577577f, -0.52179027f, -0.2392157f, 0);
    private Color color120 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.004577577f, -0.547479f, -0.14901963f, 0);
    ...
    public MyFileChooserPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
	...
	private void paintfileIconEnabled(Graphics2D g) {
	    ...
	    // bottom line
	    rect = decodeRect2();
	    g.setPaint(color3); // color for fileIcon bottom line
	    g.fill(rect);
	    // ecke rechts oben
	    path = decodePath2();
