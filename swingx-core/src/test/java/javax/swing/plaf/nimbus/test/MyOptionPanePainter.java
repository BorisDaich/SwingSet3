...
//import javax.swing.plaf.nimbus.AbstractRegionPainter.PaintContext; // not visible
...
, OptionPanePainter.INFORMATIONICON_ENABLED
, new Insets(0, 0, 0, 0)
, new Dimension(48, 48)
...
// copy final class OptionPanePainter extends AbstractRegionPainter :
    ...
    public MyOptionPanePainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
