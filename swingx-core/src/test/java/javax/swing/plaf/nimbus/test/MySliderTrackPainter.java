...
// copy of final class SliderTrackPainter extends AbstractRegionPainter
public class MySliderTrackPainter extends AbstractRegionPainter implements NimbusColors {

	private static final Logger LOG = Logger.getLogger(MySliderTrackPainter.class.getName());
...
in NimbusDefaults:
        ...
        , SliderTrackPainter.BACKGROUND_ENABLED
 ...
 */
    ...
    public static Painter<JComponent> factory(int state) {
    	PaintContext ctx = new PaintContext
    			...
    			, 1.0, 1.0);
    	return new MySliderTrackPainter(ctx, state);
    }

// copy of final class javax.swing.plaf.nimbus.SliderTrackPainter extends AbstractRegionPainter starts here :
    ...
    public MySliderTrackPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
