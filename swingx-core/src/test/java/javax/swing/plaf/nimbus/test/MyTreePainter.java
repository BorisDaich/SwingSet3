...
// copy of final class TreePainter extends AbstractRegionPainter
public class MyTreePainter extends AbstractRegionPainter implements NimbusColors {

	private static final Logger LOG = Logger.getLogger(MyTreePainter.class.getName());
	
/*
in NimbusDefaults:
        d.put("Tree[Enabled].leafIconPainter"
        , new LazyPainter("javax.swing.plaf.nimbus.TreePainter"
        , TreePainter.LEAFICON_ENABLED
        , new Insets(5, 5, 5, 5), new Dimension(16, 16)
        ...
        d.put("Tree[Enabled].openIconPainter", new LazyPainter("javax.swing.plaf.nimbus.TreePainter", TreePainter.OPENICON_ENABLED
        , new Insets(5, 5, 5, 5), new Dimension(16, 16), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        d.put("Tree.openIcon", new NimbusIcon("Tree", "openIconPainter", 16, 16));
        d.put("Tree[Enabled].collapsedIconPainter", new LazyPainter("javax.swing.plaf.nimbus.TreePainter", TreePainter.COLLAPSEDICON_ENABLED
        , new Insets(5, 5, 5, 5), new Dimension(18, 7), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
        ...
        , new LazyPainter("javax.swing.plaf.nimbus.TreePainter"
        , TreePainter.EXPANDEDICON_ENABLED_SELECTED
        , new Insets(5, 5, 5, 5), new Dimension(18, 7), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
 ...
 */
    ...
    public static Painter<JComponent> factory(int state) {
    	PaintContext ctx = new PaintContext
    			...
    			, 1.0, 1.0);
    	return new MyTreePainter(ctx, state);
    }

// copy of final class javax.swing.plaf.nimbus.TreePainter extends AbstractRegionPainter starts here :
    ...
    public static final int LEAFICON_ENABLED = 4;
    public static final int CLOSEDICON_ENABLED = 5;
    public static final int OPENICON_ENABLED = 6;
    public static final int COLLAPSEDICON_ENABLED = 7;
    public static final int COLLAPSEDICON_ENABLED_SELECTED = 8;
    public static final int EXPANDEDICON_ENABLED = 9;
    public static final int EXPANDEDICON_ENABLED_SELECTED = 10;
    ...
    private Color color1 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", 0.007936537f, -0.065654516f, -0.13333333f, 0);
    private Color color2 = new Color(97, 98, 102, 255);
    private Color color3 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", -0.032679737f, -0.043332636f, 0.24705881f, 0);
    private Color color4 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", 0.0f, -0.110526316f, 0.25490195f, 0);
    private Color color5 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0077680945f, -0.51781034f, 0.3490196f, 0);
    private Color color6 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.013940871f, -0.599277f, 0.41960782f, 0);
    private Color color7 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.4198052f, 0.14117646f, 0);
    private Color color8 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0f, -0.6357143f, 0.45098037f, -127);
    private Color color9 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", 0.0f, 0.0f, -0.21f, -99);
    private Color color10 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 2.9569864E-4f, -0.45978838f, 0.2980392f, 0);
    private Color color11 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0015952587f, -0.34848025f, 0.18823528f, 0);
    private Color color12 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0015952587f, -0.30844158f, 0.09803921f, 0);
    private Color color13 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0015952587f, -0.27329817f, 0.035294116f, 0);
    private Color color14 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.6198413f, 0.43921566f, 0);
    private Color color15 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0f, -0.6357143f, 0.45098037f, -125);
    private Color color16 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0f, -0.6357143f, 0.45098037f, -50);
    private Color color17 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0f, -0.6357143f, 0.45098037f, -100);
    private Color color18 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0012094378f, -0.23571429f, -0.0784314f, 0);
    private Color color19 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 2.9569864E-4f, -0.115166366f, -0.2627451f, 0);
    private Color color20 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0027436614f, -0.335015f, 0.011764705f, 0);
    private Color color21 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0024294257f, -0.3857143f, 0.031372547f, 0);
    private Color color22 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0018081069f, -0.3595238f, -0.13725492f, 0);
    private Color color23 = new Color(255, 200, 0, 255);
    private Color color24 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.33496243f, -0.027450979f, 0);
    private Color color25 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0019934773f, -0.361378f, -0.10588238f, 0);
    private Color color26 = MyPaintContext.decodeColor(NIMBUS_BLUEGRAY, "nimbusBlueGrey", -0.6111111f, -0.110526316f, -0.34509805f, 0);


    //Array of current component colors, updated in each paint call
    private Object[] componentColors;

    public MyTreePainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
