...
// copy of final class SliderThumbPainter extends AbstractRegionPainter
public class MySliderThumbPainter extends AbstractRegionPainter implements NimbusColors {

	private static final Logger LOG = Logger.getLogger(MySliderThumbPainter.class.getName());
...
in NimbusDefaults:
    ...
    , SliderThumbPainter.BACKGROUND_ENABLED, new Insets(5, 5, 5, 5), new Dimension(17, 17), false, AbstractRegionPainter.PaintContext.CacheMode.FIXED_SIZES, 1.0, 1.0));
    ...
    , new Insets(5, 5, 5, 5), new Dimension(17, 17)
 ...
 */
    ...
    public static Painter<JComponent> factory(int state) {
    	PaintContext ctx = new PaintContext
    			...
    			, 1.0, 1.0);
    	return new MySliderThumbPainter(ctx, state);
    }

// copy of final class javax.swing.plaf.nimbus.SliderThumbPainter extends AbstractRegionPainter starts here :
    ...
    private Color color1 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.021348298f, -0.5625436f, 0.25490195f, 0);
    private Color color2 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.015098333f, -0.55105823f, 0.19215685f, 0);
    ...
    private Color color10 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 5.1498413E-4f, -0.43866998f, 0.24705881f, 0);
    private Color color11 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 5.1498413E-4f, -0.45714286f, 0.32941175f, 0);
    private Color color12 = MyPaintContext.decodeColor(NIMBUSFOCUS, "nimbusFocus", 0.0f, 0.0f, 0.0f, 0);
    private Color color13 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0038217902f, -0.15532213f, -0.14901963f, 0);
    private Color color14 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.57865167f, -0.6357143f, -0.54509807f, 0);
    private Color color15 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.62780917f, 0.44313723f, 0);
    private Color color16 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 2.9569864E-4f, -0.4653107f, 0.32549018f, 0);
    private Color color17 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 5.1498413E-4f, -0.4563421f, 0.32549018f, 0);
    private Color color18 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0017285943f, -0.4732143f, 0.39215684f, 0);
    private Color color19 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0015952587f, -0.04875779f, -0.18823531f, 0);
    ...
    private Color color27 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.0023007393f, -0.11332625f, -0.28627452f, 0);
    private Color color28 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.023096085f, -0.62376213f, 0.4352941f, 0);
    private Color color29 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 0.004681647f, -0.594392f, 0.39999998f, 0);
    private Color color30 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", -0.0017285943f, -0.4454704f, 0.25490195f, 0);
    private Color color31 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 5.1498413E-4f, -0.4625541f, 0.35686272f, 0);
    private Color color32 = MyPaintContext.decodeColor(NIMBUSBASE, "nimbusBase", 5.1498413E-4f, -0.47442397f, 0.4235294f, 0);


    //Array of current component colors, updated in each paint call
    private Object[] componentColors;

    public MySliderThumbPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
