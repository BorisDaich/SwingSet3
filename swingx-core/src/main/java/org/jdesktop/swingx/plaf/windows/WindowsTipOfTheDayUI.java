...
public class WindowsTipOfTheDayUI extends BasicTipOfTheDayUI {
	...
	protected void installComponents() {
		...
		// do not make extra font, respect the user prop for tipFont, 
		// wg. https://github.com/homebeaver/SwingSet/issues/27#issuecomment-1205836748
		didYouKnow.setFont(tipFont);
