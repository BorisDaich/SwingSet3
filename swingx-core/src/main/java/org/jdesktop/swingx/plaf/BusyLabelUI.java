...
public interface BusyLabelUI {
    ...
    /**
	 * @param dim Dimension of the BusyPainter
     * @return The BusyPainter for the JXBusyLabel. 
     * If this method returns null, then no progress indication will be shown by busy label.
     */
