...
/**
 * A class for determining the state of the <code>java.awt.event.KeyEvent.VK_CAPS_LOCK</code> key. 
...
public final class CapsLockSupport extends AbstractBean implements KeyEventDispatcher {
    ...
    /**
     * Determines the current state of the <code>java.awt.event.KeyEvent.VK_CAPS_LOCK</code> key.
     * 
