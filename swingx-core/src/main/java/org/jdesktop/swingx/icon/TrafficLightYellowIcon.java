 ...
 */
public class TrafficLightYellowIcon implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private TrafficLightYellowIcon() {
    ...
    public static RadianceIcon of(int width, int height) {
       TrafficLightYellowIcon base = new TrafficLightYellowIcon();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return TrafficLightYellowIcon::new;
    }
}
