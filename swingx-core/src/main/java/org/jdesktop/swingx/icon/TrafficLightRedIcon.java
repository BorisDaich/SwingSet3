 ...
 */
public class TrafficLightRedIcon implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       TrafficLightRedIcon base = new TrafficLightRedIcon();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return TrafficLightRedIcon::new;
    }
}
