 ...
 */
public class FolderPlusIcon implements RadianceIcon {
...
generalPath.moveTo(22.0f, 19.0f);
generalPath.curveTo(22.0f, 20.10457f, 21.10457f, 21.0f, 20.0f, 21.0f);
generalPath.lineTo(4.0f, 21.0f);
generalPath.curveTo(2.8954306f, 21.0f, 2.0f, 20.10457f, 2.0f, 19.0f);
...
generalPath.curveTo(21.10457f, 6.0f, 22.0f, 6.8954306f, 22.0f, 8.0f);
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Line2D.Float(12.000000f,11.000000f,12.000000f,17.000000f);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Line2D.Float(9.000000f,14.000000f,15.000000f,14.000000f);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       FolderPlusIcon base = new FolderPlusIcon();
       base.width = width;
       base.height = height;
       return base;
    }
