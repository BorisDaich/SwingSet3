...
/*
 * generiert aus feather chevron und hierhin kopiert + organize imports
 ...
 */
public class ChevronIcon implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       ChevronIcon base = new ChevronIcon();
       base.width = width;
       base.height = height;
       return base;
    }
