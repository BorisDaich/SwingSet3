 ...
 */
public class DeletedIcon implements RadianceIcon {
...
shape = new RoundRectangle2D.Double(3.0, 3.0, 18.0, 18.0, 4.0, 4.0);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Line2D.Float(9.000000f,9.000000f,15.000000f,15.000000f);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
paint = (colorFilter != null) ? colorFilter.filter(new Color(0, 0, 0, 255)) : new Color(0, 0, 0, 255);
stroke = new BasicStroke(2.0f,1,1,4.0f,null,0.0f);
shape = new Line2D.Float(15.000000f,9.000000f,9.000000f,15.000000f);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
g.setTransform(transformsStack.pop());
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       DeletedIcon base = new DeletedIcon();
       base.width = width;
       base.height = height;
       return base;
    }
